...
<div class="col">
  ...
  <p>Sign as:</p>
  <div class="reg-btn">
  <a href="../doc/doctor.php"><button type="button" class="btn-reg">Doctor</button></a>
  <a href="../hospital/hosp.php"><button type="button" class="btn-reg">Hospital</button></a>
  <a href="../pat/pat.php"><button type="button" class="btn-reg ">Patient</button></a>
  </div>
